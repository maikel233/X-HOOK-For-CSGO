...
const std::map<int, PaintNames_t> itemSkins = {
	...
	{ 682,{ "#PaintKit_hy_p2000_oceani_Tag", "mac10_oceani" } }, // Memory view #PaintKit_hy_mac10_oceani_Tag... it's still there but for some reason it says invalid string? 
	{ 683,{ "#PaintKit_gs_r8_llamacannon_Tag", "r8_llamacannon" } },
	{ 685,{ "#PaintKit_hy_bizon_torn_green_Tag", "hy_scar20_jungle_slipstream" } },
	...
	{ 753,{ "#PaintKit_cu_ump45_x-ray_machine_Tag", "ump45_x-ray_machine" } },
	{ 781,{ "#PaintKit_cu_ump45_x-ray_machine_Tag", "ump45_x-ray_machine" } },
		////MP5-SD Skins

		//MP5SD | Co - Processor - 781
		//MP5SD | Dirt Drop - 753
