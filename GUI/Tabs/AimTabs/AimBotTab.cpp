	...
	ImGui::NextColumn();
	{
		ImGui::BeginChild("COL2", ImVec2(0, 0), true);
		{
			...
			ImGui::Columns(2, NULL, true);
			{
				...
				ImGui::Checkbox("Aim BT", &Settings::Aimbot::btaim);
				ImGui::Checkbox("Enabled Fake Latency", &Settings::Aimbot::fakeLat);
				ImGui::SliderInt("##TimeLimit", &Settings::Aimbot::timeLimit, 0, 400, "BT Time limit ms %0.f");
				ImGui::Checkbox("BT Ignore smoke", &Settings::Aimbot::ignoreSmoke);
