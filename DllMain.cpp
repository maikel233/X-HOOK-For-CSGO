...
//	Offsets::getSequenceActivity = (DWORD)(FindPatternV2("client_panorama.dll", "55 8B EC 53 8B 5D 08 56 8B F1 83"));
	pGlowManager = *(CGlowObjectManager **)(FindPatternV2("client_panorama.dll", "0F 11 05 ? ? ? ? 83 C8 01 C7 05 ? ? ? ? 00 00 00 00") + 3);
	MsgFunc_ServerRankRevealAll = reinterpret_cast<MsgFunc_ServerRankRevealAllFn>(FindPatternV2("client_panorama.dll", "55 8B EC 8B 0D ? ? ? ? 68 ? ? ? ? "));
...
//	pViewRender = **reinterpret_cast<CViewRender***>(FindPatternV2("client_panorama.dll", "FF 50 14 E8 ? ? ? ? 5D") - 7);
	...
	KeyValues_KeyValues = FindPatternV2(XorStr("client_panorama.dll"), XorStr("55 8B EC 51 33 C0 C7 45"));
...
//	pGameRules = *(CSGameRulesProxy***)(FindPattern("client_panorama.dll", "\xA1\x00\x00\x00\x00\x85\xC0\x0F\x84\x00\x00\x00\x00\x80\xB8\x00\x00\x00\x00\x00\x0F\x84\x00\x00\x00\x00\x0F\x10\x05", "x????xxxx????xx?????xx????xxx") + 0x1);
	csPlayerResource = *(C_CSPlayerResource***)(FindPatternV2("client_panorama.dll", "8B 3D ? ? ? ? 85 FF 0F 84 ? ? ? ? 81 C7") + 2);// "\xA1\x00\x00\x00\x00\x57\x85\xC0\x74\x08", "x????xxxxx") + 1);
	...
	pMoveHelper = **(IMoveHelper***)(FindPatternV2("client_panorama.dll", "8B 0D ? ? ? ? 8B 46 08 68") + 2); //test // "\x8B\x0D\x00\x00\x00\x00\x8B\x45\x00\x51\x8B\xD4\x89\x02\x8B\x01", "xx????xx?xxxxxxx") + 2);
	...
	pInput = *(CInput**)(FindPatternV2("client_panorama.dll", "B9 ? ? ? ? F3 0F 11 04 24 FF 50 10") + 1);
