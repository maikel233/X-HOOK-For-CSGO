...
//
//	bool result = Hooks::SteamGameCoordinator()->SendMessage(k_EMsgGCCStrike15_v2_MatchmakingClient2GCHello | ((DWORD)1 << 31), ptr, Message.ByteSize() + 8) == k_EGCResultOK;
//
//	free(ptr);
//	return result;
//}
				...
				case 1:
					...
					ImGui::Columns(2, NULL, true);
					{
						ImGui::BeginChild("COL1", ImVec2(0, 0), true);
						{
							...
							//	ImGui::Combo(XorStr("##CHAMMODE"), (int*)&Settings::ESP::Chams::mode, ChamModes, IM_ARRAYSIZE(ChamModes));
					...
					ImGui::Columns(2, NULL, true);
					{
						ImGui::BeginChild("Child1", ImVec2(0, 0), true);
						{
							...
							ImGui::Columns(3, NULL, true);
							{
								...
								ImGui::Checkbox("Chat Kill - Default", &Settings::Spammer::KillSpammer::enabledSync);
								...
								//	ImGui::Checkbox("Chat BombCountDown", &Settings::Spammer::KillSpammer::enabledBombTimerCountdown);
...
//								UI::KeyBindButton(&Settings::Teleport::key);
				...
				//		//Hooks::SendClientHello();
				//	}
				//	ImGui::NextColumn();
				//	ImGui::Checkbox("Enable Profile Changer", &Settings::InventoryChanger::enabled);
				//	
				//	ImGui::SliderInt(XorStr("##MISCWINS"), (int*)&Settings::Misc::misc_Wins, 0, 1337, XorStr("Wins: %1.f"));
				//	ImGui::SliderInt(XorStr("##MISCFRIENDLY"), (int*)&Settings::Misc::misc_Friendly, 0, 1337, XorStr("Friendly: %1.f"));
				//	ImGui::SliderInt(XorStr("##MISCLEADER"), (int*)&Settings::Misc::misc_Leader, 0, 1337, XorStr("Leader: %1.f"));
				//	ImGui::SliderInt(XorStr("##MISCTEACHER"), (int*)&Settings::Misc::misc_Teacher, 0, 1337, XorStr("Teacher: %1.f"));
				//	ImGui::SliderInt(XorStr("##MISCLEVEL"), (int*)&Settings::Misc::misc_Level, 1, 40, XorStr("Level: %1.f"));
				//	ImGui::SliderInt(XorStr("##MISCEXPERIENCE"), (int*)&Settings::Misc::misc_XP, 0, 5000, XorStr("Experience: %1.f"));

				//	ImGui::Combo(("Rank"), &Settings::Misc::misc_Rank, ranklist, ARRAYSIZE(ranklist));
				//	if (Settings::Misc::misc_Rank >= 1)
				//	{
				//		Settings::Misc::misc_Rank = Settings::Misc::misc_Rank;
				//	}
				//	else
				//	{
