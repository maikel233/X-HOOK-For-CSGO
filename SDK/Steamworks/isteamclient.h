...
public:
	...
	virtual ISteamUser *GetISteamUsers( HSteamUser hSteamUser, HSteamPipe hSteamPipe, const char *pchVersion ) = 0;
	...
	virtual void *GetISteamGenericInterfaces(HSteamUser hSteamUser, HSteamUser hSteamPipe, const char *pchVersion ) = 0;
