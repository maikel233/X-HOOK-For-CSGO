...
void Offsets::GetOffsets()
{
	...
	offsets.DT_BaseCombatCharacter.m_flNextAttack = NetVarManager::GetOffset(tables, "DT_BaseCombatCharacter", "m_flNextAttack");
	...
	offsets.DT_CSPlayer.m_flFriction = NetVarManager::GetOffset(tables, "DT_CSPlayer", "m_flFriction");
	...
	offsets.DT_CSPlayer.m_bHasHeavyArmor = NetVarManager::GetOffset(tables, "DT_CSPlayer", "m_bHasHeavyArmor");
	...
	offsets.DT_BaseCombatWeapon.m_iClip2 = NetVarManager::GetOffset(tables, "DT_BaseCombatWeapon", "m_iPrimaryReserveAmmoCount");
	...
	offsets.DT_ServerAnimationData.m_flFrozen = NetVarManager::GetOffset(tables, ("DT_BaseAnimating"), ("m_flFrozen"));
